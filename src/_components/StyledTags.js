...
display: block;
color: ${(props) => (props.color ? props.color : cssConstants.PRIMARY_LIGHT_BLACK)};
font-size: ${(props) => (props.size ? props.size : cssConstants.SUBHEADING_SIZE_S1)};
font-weight: ${(props) => (props.weight ? props.weight : cssConstants.SUBHEADING_WEIGHT_S1)};
`;
...
font-weight: ${(props) => (props.weight ? props.weight : cssConstants.LABEL_WEIGHT)};
`;
