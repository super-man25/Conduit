...
function mapStateToProps(state) {
  return {
    ticketIntegrations: selectors.selectTicketIntegrations(state),
    loading: selectors.selectTicketIntegrationsLoading(state),
    error: selectors.selectTicketIntegrationsError(state)
  };
}

export const TicketIntegrations = connect(mapStateToProps, {
